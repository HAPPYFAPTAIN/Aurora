...
import { BookOpen, Bot, Clock3, Database, History, MessageSquareText, NotebookText, PanelLeft, PenLine, Search, Settings, SlidersHorizontal, Sparkles, Workflow, X } from 'lucide-react'
...
type ActivityItemId = 'writing' | 'story' | 'timeline' | 'memory' | 'lore' | 'teller' | 'versions' | 'diagram' | 'books' | 'skills' | 'agents' | 'automations'
...
const DEFAULT_INTERACTIVE_ACTIVITY_ORDER: ActivityItemId[] = ['story', 'timeline', 'memory', 'lore', 'teller', 'versions', 'diagram', 'books', 'skills', 'agents', 'automations']
