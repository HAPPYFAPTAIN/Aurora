const settings = {
  ...
  'settings.ttsApi.profilesHint': 'Configure TTS API settings. Compatible with OpenAI TTS endpoint (/audio/speech). Enter the voice name supported by your API after connecting.',
