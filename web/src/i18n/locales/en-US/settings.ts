const settings = {
  ...
  'settings.section.ttsApi': 'TTS Speech',
  'settings.ttsApi.profiles': 'TTS Profiles',
  'settings.ttsApi.defaultProfile': 'Default TTS Profile',
  'settings.ttsApi.apiKey': 'API Key',
  'settings.ttsApi.baseUrl': 'API Base URL',
  'settings.ttsApi.model': 'Model',
  'settings.ttsApi.voice': 'Voice',
  'settings.ttsApi.voicePlaceholder': 'Enter voice name supported by your API',
  'settings.ttsApi.format': 'Audio Format',
  'settings.ttsApi.speed': 'Speed (0.25-4.0)',
  'settings.ttsApi.addProfile': 'Add TTS Profile',
  'settings.ttsApi.profileName': 'Profile Name',
  'settings.ttsApi.profilesHint': 'Configure TTS API settings. Supports OpenAI-compatible and Step Fun. Enter the voice name supported by your API after connecting.',
  'settings.ttsApi.voiceHint': 'Options: alloy, echo, fable, onyx, nova, shimmer, coral, sage, ash, ballad',
  'settings.ttsApi.provider': 'Provider',
  'settings.ttsApi.voiceStepFunHint': 'e.g. cixingnansheng, cixinvsheng',
  'settings.ttsApi.instruction': 'Voice Style Instruction',
  'settings.ttsApi.instructionPlaceholder': 'e.g. gentle tone, slower pace',
  'settings.ttsApi.voiceLoading': 'Loading voices...',
  'settings.ttsApi.voiceEmpty': 'No voices available',
  'settings.ttsApi.voiceFetchError': 'Failed to fetch voices',
  'settings.ttsApi.voiceSelectHint': 'Select from list or type manually',
